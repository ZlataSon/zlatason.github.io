...
tasks.push({
    title: "Почти счастливое число. Петя любит счастливые числа. Всем известно, что счастливыми являются положительные целые числа," +
    " в десятичной записи которых содержатся только счастливые цифры 4 и 7. Например, числа 47, 744, 4 являются счастливыми," +
    "а 5, 17, 467 — не являются. К сожалению, не все числа счастливые. Петя называет число почти счастливым, если количество " +
    "счастливых цифр в нем — счастливое число. Ему интересно, является ли число n почти счастливым. Входные данные В единственной " +
    "строке задано целое число n (1 ≤ n.length ≤ 1018). Выходные данные true, если число n — почти счастливое, и false в" +
    "противном случае.Note: обратите внимание на что такое число и цифра. ",
